...
<template>
  <main class="p-6">
    <h1 class="mb-4 text-2xl font-black tracking-wide">Vapes</h1>
    <ProductControls />
    <div class="flex gap-8">
      <aside class="w-40 shrink-0 order-last">
        <GroupDrillButton :gl="groupList" />
        <FilterPanel :filters="['strain', 'size', 'tag']" :products="categoryProducts" :facets="facets" />
      </aside>
      <div class="flex-1 min-w-0">
        <GroupableList ref="groupList" :products="filtered" :groupers="['vape-potency', 'strain', 'vape-price']" />
      </div>
    </div>
  </main>
</template>
