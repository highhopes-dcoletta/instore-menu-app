...
describe('parseQuantity', () => {
  ...
  it('parses decimal oz', () => expect(parseQuantity('1oz')).toBe(28))
  it('parses 0.5oz', () => expect(parseQuantity('0.5oz')).toBe(14))
  it('parses 1/8oz', () => expect(parseQuantity('1/8oz')).toBeCloseTo(3.5, 1))
  it('parses 1/4oz', () => expect(parseQuantity('1/4oz')).toBe(7))
  it('parses 1/4 oz with space', () => expect(parseQuantity('1/4 oz')).toBe(7))
  it('parses 1/2oz', () => expect(parseQuantity('1/2oz')).toBe(14))
